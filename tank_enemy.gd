...
# --- Enemy Stats ---
@export var movement_speed: float = 1.5 #slow as hell
@export var gravity_strength: float = 12.0
@export var max_health: int = 6 #super fuckin strong
@export var money_value: int = 50 #but you be making big bucks
#ENEMY DAMAGE--------------------------
@export var damage: int = 30 # Like god damn
...
func die() -> void:
	...
	money.money_value = money_value #set higher money values
